...
- **OpenAI baseline: NOT RUN in this invocation.** The harness takes `--provider openai_compatible`; see `docs/llm-detector-openai.md` for the hosted row. No hosted numbers are estimated in its place.
