...
### SOP EDITH — Plain-language guide for the team
...
**One sentence:** SOP EDITH is an **agentic industrial safety intelligence layer** — a LangGraph multi-agent brain over plant context (sensors, permits, maintenance, workforce) that detects compound risk, cites historical near-misses, and helps a shift supervisor run a structured, explainable **Operational Review** before authorizing high-risk work.
