...
Do **not** present SOP EDITH as another application people must remember to open.

**Positioning:**

> This operational decision already exists today. It currently happens through paper permits, phone calls, WhatsApp, SCADA screens, and operator experience. SOP EDITH provides a structured, explainable, and auditable Operational Review for a decision that already exists.
...
- **A — Multi-system blindness → compound block** — your "compliance gate": every silo says fine; SOP EDITH says BLOCK
