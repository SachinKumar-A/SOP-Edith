...
> **One prevented compound-risk incident pays for a plant-wide SOP EDITH deployment
...
it in time. SOP EDITH is the synthesis layer. Its value is the incidents it prevents.
...
## 2. Why SOP EDITH is positioned to prevent them — from our own eval
...
- The SOP EDITH compound engine **misses zero (0.0% FN)** on the same independent labels,
...
these systems by manual handoff — the gap SOP EDITH closes.)
...
| Plausible SOP EDITH cost for one plant (software + integration + ops, modeled) | **< ₹1–2 cr/yr** |
