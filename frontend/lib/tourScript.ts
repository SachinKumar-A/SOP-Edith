...
/**
 * "SOP EDITH, Season 1" — the Grand Tour script.
 *
...
export const TOUR_STEPS: TourStep[] = [
  // ── Overture ──────────────────────────────────────────────────────────
  {
    ...
    body:
      "In disasters like the Visakhapatnam coke-oven explosion, the sensors were reading, the permits were filed, the crews were logged — but nothing connected them into a decision in time. SOP EDITH is that missing intelligence layer. Take your seats: here's the whole show in ninety seconds.",
    route: "/operator",
    placement: "center",
    autoMs: 8000,
    onEnter: (ctx) => {
