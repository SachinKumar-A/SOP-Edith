...
app = FastAPI(title="SOP EDITH API", version="0.9.0", lifespan=lifespan)
...
from app.patterns.routes import router as patterns_router
...
async def ping() -> PingResponse:
    return PingResponse(message="pong from sop-edith backend")
