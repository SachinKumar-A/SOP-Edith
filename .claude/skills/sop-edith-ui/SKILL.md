---
name: sop-edith-ui
description: UI/UX conventions and verification loop for the SOP EDITH frontend. Use when changing any file under frontend/ — styling, layout, copy, panels, themes, or visual polish. Covers the token/theme system, the operator-page density rule, the demo-legibility rules the hackathon judges score, and how to screenshot the running app before claiming a change works.
---
